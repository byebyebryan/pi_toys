...
if __name__ == '__main__':
    import dispy, random, argparse, resource, threading, logging, decimal, cluster_config
    ...
    cluster = dispy.JobCluster(compute, nodes=cluster_config.nodes, ip_addr=cluster_config.manager_ip, callback=job_callback, loglevel=logging.INFO)
    pending_jobs = {}
